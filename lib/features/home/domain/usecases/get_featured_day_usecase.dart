...
class GetFeaturedDayUseCase
    extends UseCase<FeaturedDayResponse, GetFeaturedDayParams> {
  final Future<Either<Failure, FeaturedDayResponse>> Function({
    String? language,
  })
  _getFeaturedDay;
  ...
  @override
  Future<Either<Failure, FeaturedDayResponse>> call(
    GetFeaturedDayParams params,
  ) async {
