...
final segmentUrlResolverDatasourceProvider =
    Provider<SegmentUrlResolverDatasource>((ref) {
      final dio = ref.watch(dioProvider);
      return SegmentUrlResolverDatasource(dio: dio);
    });

/// Provider for segment URL resolver repository
final segmentUrlResolverRepositoryProvider =
    Provider<SegmentUrlResolverRepository>((ref) {
