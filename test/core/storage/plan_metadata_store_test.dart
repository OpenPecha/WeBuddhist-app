...
void main() {
  ...
  group('series-scheduled marker', () {
    ...
    test('set → readable for the same date only', () async {
      ...
      expect(
        PlanMetadataStore.wasSeriesScheduledOn('p-1', yesterday),
        isFalse,
      );
    });
    ...
    test('reverse lookup maps notification IDs to plan IDs for today', () async {
      ...
      expect(ids[333], 'p-3');
      expect(ids.containsKey(444), isFalse,
